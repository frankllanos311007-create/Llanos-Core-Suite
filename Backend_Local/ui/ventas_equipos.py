...
class VentasEquiposWidget(QWidget):
    ...
    def _build_form(self) -> QScrollArea:
        ...
        row_pr = QHBoxLayout()
        lbl_p = QLabel("PRECIO TOTAL DEL EQUIPO ($):"); lbl_p.setStyleSheet("color:#8B949E; font-size:14px; font-weight:bold;")
        ...
        self.btn_save = QPushButton("💾  Guardar"); self.btn_save.setObjectName("btn_success"); self.btn_save.setFixedHeight(44); self.btn_save.setCursor(Qt.CursorShape.PointingHandCursor); self.btn_save.clicked.connect(self._save_venta_equipo)
    ...
    def _load_data(self, data: dict):
        ...
        QMessageBox.information(self, "Datos Cargados", "Se han importado los datos.")
    ...
    def _send_whatsapp(self):
        ...
        msg = (f"Hola *{data['cliente']}*, le saluda *Llanos Core*. 👋\n\n"
               f"Le informamos que su equipo (Factura *{data['numero']}*) ya está listo.\n"
