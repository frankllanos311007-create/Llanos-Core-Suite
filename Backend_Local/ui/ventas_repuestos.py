...
class VentasRepuestosWidget(QWidget):
    ...
    def _build_form(self) -> QScrollArea:
        ...
        self.btn_save = QPushButton("💾  Guardar"); self.btn_save.setObjectName("btn_success"); self.btn_save.setFixedHeight(44); self.btn_save.setCursor(Qt.CursorShape.PointingHandCursor); self.btn_save.clicked.connect(self._save_venta)
